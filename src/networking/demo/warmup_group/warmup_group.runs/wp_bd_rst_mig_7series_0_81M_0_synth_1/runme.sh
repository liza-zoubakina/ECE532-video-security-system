...
HD_PWD='C:/warmup_group/warmup_group.runs/wp_bd_rst_mig_7series_0_81M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wp_bd_rst_mig_7series_0_81M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wp_bd_rst_mig_7series_0_81M_0.tcl
