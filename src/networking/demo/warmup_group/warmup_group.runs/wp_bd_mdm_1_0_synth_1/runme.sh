...
HD_PWD='C:/warmup_group/warmup_group.runs/wp_bd_mdm_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wp_bd_mdm_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wp_bd_mdm_1_0.tcl
