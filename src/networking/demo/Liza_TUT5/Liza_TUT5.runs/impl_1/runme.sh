...
HD_PWD='C:/Liza_TUT5/Liza_TUT5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TUT5_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TUT5_bd_wrapper.tcl -notrace
