...
HD_PWD='C:/Liza_TUT5/Liza_TUT5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TUT5_bd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TUT5_bd_wrapper.tcl
